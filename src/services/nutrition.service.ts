  ...
  public mappedChildren = (
    ...
    const mappedNutritionHistories = nutritionHistories.map((nutritionHistory) => {
      return {
        ...
        child_name: nutritionHistory.child_name,
        child_nik: nutritionHistory.child_nik,
        child_village: nutritionHistory.child_village,
        date_of_birth: nutritionHistory.date_of_birth,
    ...
    const mappedChild = {
      ...
      child_nik: nutritionHistories[0].child_nik as string,
      child_village: nutritionHistories[0].child_village as string,
      date_of_birth: nutritionHistories[0].date_of_birth as Date,
  ...
  public mappedChildrens = (
    ...
    const mappedNutritionHistories = Object.keys(groupedNutritionHistories).map((key) => {
      ...
      return {
        ...
        child_nik: latestNutritionHistory.child_nik,
        child_village: latestNutritionHistory.child_village,
        date_of_birth: latestNutritionHistory.date_of_birth,
